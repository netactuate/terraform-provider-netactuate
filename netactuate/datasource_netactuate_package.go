...
import (
	...
	"github.com/hostvirtual/gohvapi"
	"github.com/hashicorp/terraform-plugin-sdk/helper/schema"
	"github.com/hashicorp/terraform-plugin-sdk/helper/validation"
)

func dataSourceHostVirtualPackage() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceHostVirtualPackageRead,
...
func dataSourceHostVirtualPackageRead(d *schema.ResourceData, meta interface{}) error {
...
func exportDropletProperties(d *schema.ResourceData, droplet *godo.Droplet) error {
	...
	if features := droplet.Features; features != nil {
		d.Set("backups", containsHostVirtualPackageFeature(features, "backups"))
		d.Set("ipv6", containsHostVirtualPackageFeature(features, "ipv6"))
		d.Set("private_networking", containsHostVirtualPackageFeature(features, "private_networking"))
		d.Set("monitoring", containsHostVirtualPackageFeature(features, "monitoring"))
	}

	if err := d.Set("volume_ids", flattenHostVirtualPackageVolumeIds(droplet.VolumeIDs)); err != nil {
